...
public class TERenderer {
     ...
     */
    public void renderFrame(TETile[][] world, byog.Core.Player p) {
        ...
        StdDraw.rectangle(0, height - 1, 10, 1);
        StdDraw.filledRectangle(0, height - 1, (double) p.getHealth() / 10, 1);
        StdDraw.setPenColor(Color.WHITE);
        StdDraw.textLeft(3, height - 1, "health");
        if (StdDraw.mouseX() < width && StdDraw.mouseX() >= 0 && StdDraw.mouseY() < height - 4 && StdDraw.mouseY() >= 0) {
            StdDraw.text(width / 2, height - 1, tileAt((int) StdDraw.mouseX(), (int) StdDraw.mouseY(), world));
        }
    ...
    public void renderFrame(TETile[][] world) {
        ...
        StdDraw.setPenColor(Color.WHITE);
        StdDraw.textLeft(1, height - 1, "Health: ");
        StdDraw.text(width / 2, height - 1, "Type!" + "Watch!");
        StdDraw.line(0, height - 4, width, height - 4);

        StdDraw.show();
    }

    public String tileAt(int x, int y, TETile[][] world) {
